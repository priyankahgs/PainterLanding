$(document).ready(function () {
    ...
    // let pageBottom = document.querySelector('#expresspaintingGetintouch');
...
// 	alert(IsOwnaShop)
// 	if(IsOwnaShop)
//     $('#store_Name').prop('display','block');
// 	else
// 	$('#store_Name').prop('display','none');
    ...
    // var inlineRadio1 = document.getElementById("inlineRadio1");
    // var store_Name = document.getElementById("store_Name");
    // store_Name.style.display = inlineRadio1.checked ? "block" : "none";
