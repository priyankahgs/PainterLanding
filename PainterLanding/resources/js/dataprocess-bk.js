...
function SaveExp() {
    ...
    var postdata = {
        ...
        gclid: gclid, IsHomeShield: false, IsOwnaShop: IsOwnaShop, IsChkWhatsAppAccept: isChkWhatsAppAccept
    };
    $.ajax({
...
function getValidationMessageGst() {
    var gst = document.getElementById("txtexpGst").value;
    if (gst.trim() == "" || gst.trim() == "Please enter your GSTIN Number") {
        $('#spnGst').text('Please enter your GSTIN Number')
    }
    else if (gst.trim() != "" && gst.trim() != "Please enter your GSTIN Number" == false) {
        $('#spnGst').text('Please enter your GSTIN Number');
    }
    else if (!(chkSpecialchar(gst.trim()))) {
        $('#spnGst').text('Please enter your GSTIN Number');
    }
    else {
        $('#spnGst').text('')
...
function validateExp() {
   ...
   //GST 
   var Gstno = document.getElementById("txtexpGst").value;
    if (Gstno.trim() == "" || Gstno.trim() == "Please enter your GSTIN Number") {
        $('#spnGst').text('Please enter your GSTIN Number')
        IsValid = false;
    }
    else if (Gstno.trim() != "" && Gstno.trim() != "Please enter your GSTIN Number" == false) {
        $('#spnGst').text('Please enter your GSTIN Number');
        IsValid = false;
    }
    else if (!(chkSpecialchar(Gstno.trim()))) {
        $('#spnGst').text('Please enter your GSTIN Number');
        IsValid = false;
    }
    else {
